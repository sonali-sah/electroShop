...
const Services = () => {
  ...
  return (
    <div className='w-full lg:px-20 px-5 pt-[0px] pd-[80px] grid lg:grid-cols-4 grid-cols-1 justify-center items-center gap-10'>
      <div data-aos="zoom-in" data-aos-delay="100" className='flex flex-col justify-center items-center gap-2'>
        ...
        <h1 className='text-xl text-black font-semibold'>Woldwide Shipping</h1>
